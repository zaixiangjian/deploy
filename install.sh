...
AURORA_DOCKER_YML_BACKUP=${AURORA_HOME}/docker-compose.yml.backup
DEFAULT_SECURITY_KEY="AuroraAdminPanel321"
GITHUB_RAW_URL="raw.githubusercontent.com"
GITHUB_URL="github.com"
AURORA_GITHUB="zaixiangjian"
